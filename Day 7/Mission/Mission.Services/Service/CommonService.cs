...
namespace Mission.Services.Service
{
    public class CommonService(ICommonRepository commonRepository) : ICommonService
    {
        ...
        public List<DropDownResponseModel> MissionThemeListAsync()
        {
            return _commonRepository.MissionThemeListAsync();
        }

        public List<DropDownResponseModel> MissionSkillListAsync()
        {
            return _commonRepository.MissionSkillListAsync();
        }

...
namespace Mission.Api.Controllers
{
    ...
    public class CommonController(ICommonService commonService) : ControllerBase
    {
        ...
        public ResponseResult MissionThemeListAsync()
        {
            try
            {
                result.Data = _commonService.MissionThemeListAsync();
                result.Result = ResponseStatus.Success;
            }
            catch (Exception ex)
            {
        ...
        public ResponseResult MissionSkillListAsync()
        {
            try
            {
                result.Data = _commonService.MissionSkillListAsync();
                result.Result = ResponseStatus.Success;
            }
            catch (Exception ex)
            {
